...
public class AddInstructorForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Instructor",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Roboto", 0, 14))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(cbPerson, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 6, Short.MAX_VALUE)));

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Course Search",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Roboto", 0, 14))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Department",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Roboto", 0, 14))); // NOI18N
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                layout.createSequentialGroup()
                                                        ...
                                                        .addComponent(btSave, javax.swing.GroupLayout.PREFERRED_SIZE,
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btSave, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btSearchActionPerformed
        ...
        if ((selectedValueDpm != null && selectedValueDpm instanceof Object[])
                && (selectedValuePs != null && selectedValuePs instanceof Object[])) {
    ...
    private void btSaveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btSaveActionPerformed
        ...
        if (selectedValue != null && selectedValue instanceof Object[]) {
            ...
            for (int i = 0; i < tbCourse.getRowCount(); i++) {
                if ((boolean) tbCourse.getValueAt(i, 0)
                        && !instuctorBUS.CheckExistCourseInstructor((int) tbCourse.getValueAt(i, 1), (int) pair[0])) {
                ...
                } else if (!(boolean) tbCourse.getValueAt(i, 0)
                        && instuctorBUS.CheckExistCourseInstructor((int) tbCourse.getValueAt(i, 1), (int) pair[0])) {
                    CourseInstructorDTO c = new CourseInstructorDTO((int) tbCourse.getValueAt(i, 1), (int) pair[0]);
        ...
        if (dpmID == 0) {
            ...
            for (CourseDTO c : listcourse) {
                if (c.getTitle().toLowerCase().contains(search.toLowerCase())
                        || Integer.toString(c.getCourseID()).equalsIgnoreCase(search)) {
                    row = new Object[4];
